#ifndef BleRDF_RECEIVER_MAIN_GPIO_INPUT_WATCH_TASK_H_
#define BleRDF_RECEIVER_MAIN_GPIO_INPUT_WATCH_TASK_H_
// (C)2024 bekki.jp
...
#endif  // BleRDF_RECEIVER_MAIN_GPIO_INPUT_WATCH_TASK_H_
