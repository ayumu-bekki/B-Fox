...
| 役割 | 機材 | 備考 |  
| プレイヤー | 1\. 受信機 | 専用受信機、もしくはBLE探索アプリを入れたスマートフォンを使います。 |  
...
* シールド技術
 * BLEは電波が弱く、身体や障害物で容易に遮蔽されます。スマートフォンとビーコンの間に自分の身体を入れることで信号を遮り、信号が弱くなる方向の逆がビーコンのおおよその方向だと判断するテクニックが有効です。

**ポイント**
BLE(iBeacon)は電波であり、建物や地形によって信号が反射したり、遮られたりします。
...
* 信号強度が一定の基準（-50dBm以下）になったら、物理的に周囲を捜索します。 
  * 注釈: この基準値はあくまで目安です。アプリや機種によって変動するため、現場のテスト結果を優先してください。
...
* 緊急連絡先 
 * 主催者の連絡先を周知し、緊急時にはすぐに連絡できる体制を整えてください
